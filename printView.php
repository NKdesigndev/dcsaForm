        ...
        <div class="row">
            <ol type="1" class="col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="txt-con">
                    ...
                    <p class="pr-txt">Johnny depp, Captain Jack sparrow</p>
                </div>
            ...
            <ol type="1" class="col-lg-12 col-md-12 col-sm-12">
                <div class="row">
                    ...
                    <div class="txt-con col-lg-6 col-md-6 col-sm-6 pe-3">
                        ...
                        <p class="pr-txt">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis, explicabo quia. Tempore aliquam ipsa quos quas, <br> +123456789</p>
                    </div>
                    
                    <!-- 6 (b) -->
                    <div class="txt-con col-lg-6 col-md-6 col-sm-6">
                        <li value="6" class="pr-hdr-1 list-unstyled">(b) Residential Address:</li>
                        <p class="pr-txt">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis, explicabo quia. Tempore aliquam ipsa quos quas,</p>
                    </div>
                </div>
                <!-- 7 -->
                <div class="txt-con">
                    <li value="7" class="pr-hdr-1">Nominee's field of specialization:</li>
                    <p class="pr-txt">Tempore aliquam ipsa quos quas, ipsum dolor sit amet consectetur adipisicing elit</p>
                </div>
            </ol>
                    ...
                    <div class="col-sm-12">
                        ...
                        <ul type="disc" class="row">
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                ...
                                <p class="pr-txt mb-3 ps-0">B.Sc.</p>
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <li class="pr-hdr-1">Name of the University:</li>
                                <p class="pr-txt mb-3 ps-0">Panjab University </p>
                            </div>
                            
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <li class="pr-hdr-1">Year of Passing:</li>
                                <p class="pr-txt mb-3 ps-0">2020</p>
                            </div>
                            
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <li class="pr-hdr-1">Division/Class/CGP:</li>
                                <p class="pr-txt mb-3 ps-0">First</p>
                            </div>
                            <div class="col-sm-12">
                                <li class="pr-hdr-1">Additional Particulars:</li>
                                <p class="pr-txt mb-3 ps-0">Tempore aliquam ipsa quos quas, ipsum dolor sit amet consectetur adipisicing elit</p>
                            </div>
                        </ul>
                        ...
                        <ul type="disc" class="row">
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <li class="pr-hdr-1">Name of the course:</li>
                                <p class="pr-txt mb-3 ps-0">M.Sc.</p>
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <li class="pr-hdr-1">Name of the University:</li>
                                <p class="pr-txt mb-3 ps-0">Panjab University</p>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <li class="pr-hdr-1">Year of Passing:</li>
                                <p class="pr-txt mb-3 ps-0">2022</p>
                            </div>
            ...
            <div class="col-sm-12">
                <ol type="1" class="px-3">
                    ...
                    <div class="txt-con mt-3">
                        ...
                        <p class="pr-txt p-0">Tempore aliquam ipsa quos quas, ipsum dolor sit amet consectetur adipisicing elit</p>
                    </div>
                    ...
                    <div class="txt-con mt-3">
                        ...
                        <p class="pr-txt p-0">Tempore aliquam ipsa quos quas, ipsum dolor sit amet consectetur adipisicing elit  ipsum dolor sit amet consectetur adipisicing elit</p>
                    </div>
            ...
            <ol type="1" class="px-4">
                <div class="row">
                    ...
                    <div class="txt-con col-sm-4 px-3 mt-0">
                        ...
                        <p class="pr-txt p-0">Yes, that's correct</p>
                    </div>
                </div>
                <!-- 23. -->
                <div class="row">
                    ...
                    <div class="txt-con col-sm-6 px-3 mt-0">
                        ...
                        <p class="pr-txt p-0">example@domain.com</p>
                    </div>
